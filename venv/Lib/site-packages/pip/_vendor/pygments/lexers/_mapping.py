...
LEXERS = {
    'ABAPLexer': ('pip._vendor.pygments.lexers.repositories', 'ABAP', ('abap',), ('*.abap', '*.ABAP'), ('text/x-abap',)),
    ...
    'CobolFreeformatLexer': ('pip._vendor.pygments.lexers.repositories', 'COBOLFree', ('cobolfree',), ('*.cbl', '*.CBL'), ()),
    'CobolLexer': ('pip._vendor.pygments.lexers.repositories', 'COBOL', ('cobol',), ('*.cob', '*.COB', '*.cpy', '*.CPY'), ('text/x-cobol',)),
    ...
    'GoodDataCLLexer': ('pip._vendor.pygments.lexers.repositories', 'GoodData-CL', ('gooddata-cl',), ('*.gdc',), ('text/x-gooddata-cl',)),
    ...
    'MaqlLexer': ('pip._vendor.pygments.lexers.repositories', 'MAQL', ('maql',), ('*.maql',), ('text/x-gooddata-maql', 'application/x-gooddata-maql')),
    ...
    'OpenEdgeLexer': ('pip._vendor.pygments.lexers.repositories', 'OpenEdge ABL', ('openedge', 'abl', 'progress'), ('*.p', '*.cls'), ('text/x-openedge', 'application/x-openedge')),
